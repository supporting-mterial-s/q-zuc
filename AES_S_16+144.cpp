...
void AES_S_T_DEPTH3(int *in, int *S)
{
...
//12 + 10 + 34 + 13 + 36 + 39 = 144;
//in total: 144 ancilla qubits (+ 8 input bits, 8 output bits)
...
//T-depth 1: 9 quantum and gates
QAND(U_10,  in[4], M_1, tmp_13);
QAND(U_15,  in[7], M_2, tmp_14);
QAND(U_13,  U_17,  M_4, tmp_15);
QAND(in[0], U_11,  M_6, tmp_16);
QAND(in[6], in[1], M_7, tmp_17);
QAND(U_14,  U_12,  M_9, tmp_18);
QAND(in[3], in[2], M_11,tmp_19);
QAND(U_8,   U_16,  M_12,tmp_20);
QAND(in[5], U_9,   M_14,tmp_21);
...
33 QAND gates:
        ...
        66 inputs: 25 are allocated, 66-25 = 41 should be copied, 41 ancilla qubits required, 41 CNOT gats to copy, 41 CNOT to reset.
...
in[1] = in[1] ^ in[7] ;  // y[5
tmp_10 = tmp_10 ^ in[0];
tmp_10 = tmp_10 ^ in[3] ;   //y[7
in[4] = in[4] ^ in[0] ;   //y[3
tmp_12 = tmp_12 ^ in[2] ;  // y[11
in[6] = in[6] ^ in[1] ;  // y[9
in[2] = in[2] ^ in[4]  ; // y[8
tmp_11 = tmp_11 ^ in[6];  //  y[10
in[7] = in[7] ^ in[4] ; //  y[4
tmp_9 = tmp_9 ^ in[4]  ;//  y[6
...
tmp_5 = tmp_5 ^ in[4];
in[4] = in[4] ^ in[0];//    y[3
tmp_4 = tmp_4 ^ in[0];//    y[2
tmp_6 = tmp_6 ^ in[1];
tmp_6 = tmp_6 ^ in[4];//    y[1
tmp_5 = tmp_5 ^ in[1];//    y[0
///////////////////////////////////
M_6 = M_6 ^ in[1];
M_1 = M_1 ^ in[0];
M_7 = M_7 ^ in[6];
...
M_1 = M_1 ^ M_11;
M_7 = M_7 ^ M_12;
QAND_C(in[5], U_9,   M_14);
QAND_C(U_8,   U_16,  M_12);
QAND_C(in[3], in[2], M_11);
QAND_C(U_14,  U_12,  M_9);
QAND_C(in[6], in[1], M_7);
QAND_C(in[0], U_11,  M_6);
QAND_C(U_13,  U_17,  M_4);
QAND_C(U_15,  in[7], M_2);
QAND_C(U_10,  in[4], M_1);
//9 quantum and gates:
U_15 = U_15 ^ in[6];//    y[15
U_14 = U_14 ^ in[1];//    y[13
U_12 = U_12 ^ in[2];//    y[11
